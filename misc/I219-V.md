...
This story is about one of the 2 Ethernet Adapters on the main machine in my rack, the one I talked about [here](/index.md).  
...
Why the Intel Adapter and not the Killer E2200?  
What were they smoking when they decided on the default configuration of this board?  
Can jet fuel melt steel beams?  

The board itself isn't bad by any stretch though, but I've ran into a couple of other... oddities?  
Yes. Oddities.  
...
Unfortunately, most of these people where using the device manager to manually install the `Intel(R) Ethernet Connection I219-LM` driver,
...
Step 2: use `bcedit` to turn off the safeties.  
