...
This ethernet driver drove me nuts for a couple of reasons.  
It's one of the 2 Ethernet Adapters on the main machine in my rack, the one I talked about [here](/index.md).  

Now this machine is cobbled together with parts from high end Gaming rigs.  
It has an I7-6700K and a nice GIGABYTE GA-Z170X-Gaming 5, which posses 2 Ethernet Ports.  
Specifically an `Intel(R) Ethernet Connection I219-V` and a `Killer E2200 Gigabit Ethernet Controller`.  

This is an account of the various things that made me go: *"What where they thinking?"*.  
...
Could it be that's just not in a bad state?  
...
This gives a huge security warning and in teh distance a siren started wailing.  
